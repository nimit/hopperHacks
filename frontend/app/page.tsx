...
import { Compass, Map, Pill, User } from 'lucide-react';
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            <h1 className="text-6xl font-bold text-brown mb-8 pirate-font drop-shadow-lg">
              SpotiFind Rx
            </h1>
            ...
            <div className="flex justify-center">
              <Link
                href="/auth"
                className="btn-pirate text-xl px-8 py-4 animate-bounce"
              >
                Join the Crew
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-parchment-light p-6 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <h2 className="text-2xl font-bold text-brown mb-2 pirate-font">
                Navigate Health
              </h2>
              <p className="text-brown-dark">
                Chart your course through the treacherous seas of health with
                our pirate-themed guidance.
              </p>
            </div>
            <div className="bg-parchment-light p-6 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-brown-dark">
                Discover and report obstacles on our interactive map to help
                fellow buccaneers.
              </p>
            </div>
            <div className="bg-parchment-light p-6 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <h2 className="text-2xl font-bold text-brown mb-2 pirate-font">
                Prescription Plunder
              </h2>
              <p className="text-brown-dark">
                Unlock the secrets of your prescriptions with our AI-powered
                decoding system.
              </p>
            </div>
          </div>
          ...
          <div className="bg-brown-dark p-8 rounded-lg shadow-lg relative overflow-hidden">
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-parchment mb-4 pirate-font">
                Latest Treasure Updates
              </h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-parchment p-4 rounded-lg">
                  <h3 className="text-xl font-bold text-brown-dark mb-2">
                    New Obstacle Reported
                  </h3>
                  <p className="text-brown-dark">
                    A treacherous reef has been spotted near the Port of Health.
                    Beware, sailors!
                  </p>
                </div>
                <div className="bg-parchment p-4 rounded-lg">
                  <h3 className="text-xl font-bold text-brown-dark mb-2">
                    Medicine Chest Updated
                  </h3>
                  <p className="text-brown-dark">
                    Our AI parrot has learned to recognize new prescription
                    scrolls. Try it out!
                  </p>
                </div>
              </div>
